    ...
    <div className="about-us-page">
      <div className="about-hero">
        <div className="about-hero-content">
          <h1>About Zeal Community Medical Mission Foundation</h1>
      ...
      <div className="about-content">
        <section className="about-section">
          <div className="section-image">
            <img
              src="https://images.pexels.com/photos/13548722/pexels-photo-13548722.jpeg"
          ...
          <div className="section-text">
            <h2>Our Mission</h2>
            <p>
              Zeal Community Medical Mission Foundation provides accessible, reliable, and professional healthcare services to the community.
              We prioritize your health and well-being with exceptional medical care tailored to your needs.
            </p>
            <p>
              Our dedicated team of professionals is committed to delivering quality healthcare services that make a difference in the lives of our patients and their families.
            </p>
          </div>
        </section>
        ...
        <section className="goal-section">
          <div className="goal-content">
            <h2>Our Goal</h2>
            <p>
              Provide accessible, reliable, and professional healthcare services to the community through
              compassionate care and dedicated service.
            </p>
