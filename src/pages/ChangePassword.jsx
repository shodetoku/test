      ...
      <div className="change-password-container">
        <div className="change-password-left">
          <div className="change-password-logo">
            <img src="/1000234544.png" alt="Zeal Community Medical Mission Foundation" className="change-password-logo-image" />
            <div className="change-password-logo-text">
              <span className="logo-text">ZCMMF</span>
              <span className="logo-subtitle-changepassword">Zeal Community Medical Mission Foundation</span>
            </div>
          </div>
