...
import '../../assets/styles/IntakeForm.css';
        ...
        <div className="intake-sidebar">
          <div className="sidebar-header">
            <div className="sidebar-logo">
              <img src={logoPrimary} alt="Zeal Community Medical Mission Foundation" className="sidebar-logo-image" />
              <div className="sidebar-logo-text">
                <span className="logo-text">ZCMMF</span>
                <span className="logo-subtitle-sidebar">Zeal Community Medical Mission Foundation</span>
              </div>
            </div>
          </div>
