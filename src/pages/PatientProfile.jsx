        ...
        <div className="profile-content">
                ...
                <div className="patient-meta">
                  <span className="patient-id">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                      <rect x="2" y="3" width="12" height="10" rx="1" stroke="#015396" strokeWidth="1.5"/>
                      <path d="M5 3V2M11 3V2" stroke="#015396" strokeWidth="1.5" strokeLinecap="round"/>
                    </svg>
                    ID: #PAVC500021
                  </span>
          ...
          <div className="details-card">
            <div className="section-header">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <circle cx="10" cy="6" r="3" stroke="#015396" strokeWidth="1.5"/>
                <path d="M4 17C4 13.6863 6.68629 11 10 11C13.3137 11 16 13.6863 16 17" stroke="#015396" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
          ...
          <div className="details-card medical-card">
            <div className="section-header medical-header">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <path d="M3 3H13L17 7V17H3V3Z" stroke="#015396" strokeWidth="1.5" strokeLinejoin="round"/>
                <path d="M13 3V7H17" stroke="#015396" strokeWidth="1.5" strokeLinejoin="round"/>
              </svg>
                ...
                <div className="surgery-list">
                  <div className="surgery-item">
                    <div className="surgery-icon">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <circle cx="12" cy="12" r="9" stroke="#015396" strokeWidth="2"/>
                        <path d="M9 12L11 14L15 10" stroke="#015396" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
