...
import { mockLabReports } from '../../utils/SampleData';
import '../../assets/styles/LaboratoryResults.css';
            ...
            <div className="health-status-header">
              <div className="health-status-icon">
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M8 12l2 2 4-4" stroke="#015396" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            ...
            <div className="pending-card">
              ...
              <div className="pending-icon">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none">
                  <path d="M12 8v4l3 3m6-3a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" stroke="#015396" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
            </div>
          </div>
